...
## Project Structure
    ...
    ├── testapiautodatamod_112270  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_112270`
...
2. Clone this repo and `cd testapiautodatamod_112270`
